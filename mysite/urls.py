...
urlpatterns = [
    ...
    path('experimentsetup/<int:project_id>/<int:experiment_id>/', experiments.experimentsetup, name="experimentsetup"),
    path('experimentsetup/<int:project_id>/', experiments.experimentsetuplastexperiment, name="experimentsetuplastexperiment"),
    path('experimentresults/<int:project_id>/', experiments.experimentresultslatest),
    path('experimentresults/<int:project_id>/<int:experiment_id>/', experiments.experimentresults),
